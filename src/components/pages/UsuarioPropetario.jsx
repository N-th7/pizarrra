...
const UsuarioPropietario=({nombre})=>{
    const [width, setGrosor] = useState(12);
    const frmContact = { userEmail:'', name:'', enlace:'http://localhost:3000/invitado', emailDetails:'' };
...
<div class>
                    ...
                    <input required class="w3-input w3-border w3-round-large" type="text" value={contact.userEmail} name="userEmail" onChange={handleChange}/>
                    <button className="subir" >Añadir</button>
